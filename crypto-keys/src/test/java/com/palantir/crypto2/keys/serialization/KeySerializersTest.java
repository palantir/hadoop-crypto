...
public final class KeySerializersTest {
    ...
    @Test
    public void testKeySerializersAndSymmetricKeySerializersVersionsDoNotOverlap() {
        assertThat(SERIALIZERS.keySet()).doesNotContainAnyElementsOf(SYMMETRIC_SERIALIZERS.keySet());
    }
}
